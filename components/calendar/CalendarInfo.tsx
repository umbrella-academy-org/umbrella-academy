    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 relative overflow-hidden group">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-bold text-amber-900  ">Learning Status</h3>
        ...
        <div className="space-y-6">
          {/* Active Goal */}
          <div>
            <p className="text-[10px] text-gray-400  font-bold   mb-1.5">Current Track</p>
            <h4 className="text-base font-bold text-amber-900 mb-2">Programming & Development</h4>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              <p className="text-[10px] text-gray-400 font-bold    mb-1">Sessions</p>
              <p className="text-lg font-bold text-amber-900">12/18</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg border border-gray-100">
              <p className="text-[10px] text-gray-400 font-bold    mb-1">Avg. Grade</p>
              <p className="text-lg font-bold text-amber-900">8.5</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-amber-900">Demi Wilkinson</p>
            </div>
          </div>
        </div>

        {/* Action Button */}
        <button className="w-full mt-6 py-3 bg-amber-600 text-white text-xs font-bold rounded-lg hover:bg-gray-800 transition-all active:scale-[0.98] shadow-lg shadow-gray-200">
          View Full Roadmap
        </button>
      </div>
    </div>
