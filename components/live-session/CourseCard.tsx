      ...
      <div className="flex flex-col md:flex-row gap-8 relative z-10">
        ...
        <div className="w-full md:w-48 h-36 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl flex-shrink-0 overflow-hidden relative shadow-lg">
          <div className="absolute inset-0 bg-black/40 flex items-center justify-center p-4">
            <h4 className="text-white text-sm font-semibold text-center italic leading-tight decoration-yellow-600 decoration-2 underline-offset-4 underline">
              Programming & Development
            </h4>
          </div>
          <div className="absolute bottom-2 left-2 right-2 flex justify-between">
            <span className="text-[10px] font-medium text-yellow-500 bg-black/60 px-2 py-0.5 rounded">Core Track</span>
