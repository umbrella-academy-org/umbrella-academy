  ...
  return (
    <div className="relative w-full h-full bg-linear-to-b from-slate-900 via-slate-800 to-slate-700 overflow-hidden">
              ...
              <div className="w-32 h-40 relative">
                ...
                <div className="w-full h-full bg-linear-to-b from-gray-500 to-gray-700 rounded-full relative overflow-hidden">
                  ...
                  <div className="absolute inset-0">
                    ...
                    <div className="absolute top-1/4 left-0 w-full h-1/4 bg-yellow-600"></div>
                    <div className="absolute top-2/4 left-0 w-full h-1/4 bg-yellow-600"></div>
                ...
                {/* Basket */}
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-8 h-6 bg-yellow-900 rounded-sm"></div>
              </div>
            </div>
          </div>
      ...
      <div className="absolute top-3 lg:top-6 left-3 lg:left-6 z-20">
        <div className="flex items-center gap-2 lg:gap-3 bg-yellow-600 bg-opacity-40 rounded-lg px-3 lg:px-4 py-2 lg:py-3 backdrop-blur-sm">
          <div className="w-8 h-8 lg:w-10 lg:h-10 bg-yellow-600 rounded-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-3 lg:top-6 right-3 lg:right-6 z-20 flex flex-col items-end gap-2 lg:gap-3">
        ...
        <button 
          ...
          className="bg-yellow-600 bg-opacity-40 rounded-lg p-1.5 lg:p-2 backdrop-blur-sm hover:bg-opacity-60 transition-all"
        >
          {isFullscreen ? (
      ...
      <div className="hidden lg:flex absolute left-6 top-1/2 transform -translate-y-1/2 z-20">
        <div className="flex flex-col items-center bg-yellow-600 bg-opacity-40 rounded-full p-3 backdrop-blur-sm">
          {/* Volume slider */}
          <div className="w-1 h-24 bg-yellow-600 rounded-full relative mb-3">
      ...
      <div className="absolute bottom-4 lg:bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <div className="flex items-center gap-2 lg:gap-4 bg-yellow-600 bg-opacity-40 rounded-full px-4 lg:px-6 py-3 lg:py-4 backdrop-blur-sm">
          {/* Grid View */}
          ...
          <button 
            ...
            className="w-12 h-12 lg:w-16 lg:h-16 bg-yellow-600 hover:bg-yellow-700 rounded-full flex items-center justify-center transition-all shadow-lg"
          >
