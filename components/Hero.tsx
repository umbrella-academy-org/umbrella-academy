...
export function Hero() {
  ...
  return (
    <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden bg-yellow-600 text-white mt-20">
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-6 sm:px-10 lg:px-16 flex flex-col items-start space-y-8 md:space-y-12">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 w-full md:w-auto animate-slide-up">
          <button
            ...
            className="group w-full md:w-auto px-8 md:px-12 py-4 md:py-6 bg-white text-gray-900 rounded-none hover:bg-[#525252] hover:text-white transition-all duration-500 flex items-center justify-center space-x-4 font-black text-lg md:text-xl  active:scale-95"
          >
