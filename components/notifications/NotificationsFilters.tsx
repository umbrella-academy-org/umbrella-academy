    ...
    <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 mt-6">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* More Filters Button */}
          <button className="flex items-center gap-2 text-gray-600 hover:text-amber-900 px-3 py-1 border border-gray-300 rounded-lg text-sm font-medium transition-colors">
