      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="relative flex-1 max-w-md">
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent focus:bg-white text-gray-900 placeholder:text-gray-500"
          />
