        ...
        <div className="group flex flex-col cursor-pointer">
            ...
            <div className="space-y-3 grow">
                ...
                <div className="flex justify-between items-start gap-4">
                    <h3 className="text-xl md:text-2xl font-black text-black leading-tight group-hover:text-[#ca8a04] transition-colors">
                        {title}
                    </h3>
                    <ArrowUpRight className="w-5 h-5 text-black group-hover:text-[#ca8a04] transition-colors shrink-0" />
                </div>
