            ...
            >
                ...
                <div className="relative z-10 space-y-6">
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white tracking-tighter">
                        ...
                        <span className="text-[#525252]">great together</span>
                    </h2>
                    ...
                    <div className="pt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <button className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#525252] text-white font-bold hover:bg-[#a16207] transition-colors interactive-button">
                            Get started
                        </button>
                    </div>
                </div>
