...
export default function MentorTransactionHistory() {
    ...
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">Track all your mentoring earnings and withdrawals</p>
        </div>
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="text-left py-3 px-4 text-sm font-medium text-gray-600">Mentee</th>
            </tr>
          </thead>
          <tbody>
