      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="text-right">
            <div className="text-3xl font-bold text-amber-900">RWF 180,000</div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="text-xl font-bold text-amber-900">RWF 35,000</div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <div className="text-xl font-bold text-amber-900">RWF 650,000</div>
