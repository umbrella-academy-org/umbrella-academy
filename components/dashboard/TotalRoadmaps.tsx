    ...
    return (
      <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100">
        <div className="text-center py-8">
          ...
          <h3 className="text-lg font-semibold text-amber-900 mb-2">No Roadmaps Available</h3>
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="w-32 h-24 sm:w-40 sm:h-28 bg-gradient-to-br from-gray-900 to-gray-700 rounded-lg overflow-hidden flex-shrink-0 relative group cursor-pointer">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className={`w-8 h-8 bg-amber-600 rounded-full flex items-center justify-center transition-all duration-300 ${
          ...
          <div className="absolute bottom-2 left-2 right-2">
            <div className="bg-amber-600 bg-opacity-50 rounded px-2 py-1">
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                <h3 className={`text-lg font-semibold text-amber-900 transition-colors duration-200 ${
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-amber-900">{roadmapInfo.estimatedDuration}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-right flex-shrink-0">
              <div className={`text-2xl font-bold text-amber-900 mb-1 transition-all duration-300 ${
              ...
              <div className="flex gap-2">
                ...
                <button className="px-3 py-1.5 bg-amber-600 text-white text-xs font-medium rounded-lg hover:bg-amber-700 transition-all duration-200 interactive-button transform hover:scale-105 focus:ring-2 focus:ring-gray-300">
