...
export function CTA() {
  ...
  return (
    <section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Gradient Background */}
      <div className="absolute inset-0 bg-linear-to-br from-[#525252] via-[#a16207] to-black" />

      {/* Animated Background Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#737373]/20 rounded-full blur-3xl animate-slide-x" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#525252]/30 rounded-full blur-3xl animate-slide-y" style={{ animationDelay: "1s" }} />
        ...
        <div className={`text-center space-y-8 reveal ${isVisible ? 'visible' : ''}`}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <button
              ...
              className="group px-8 py-4 bg-white text-[#525252] rounded-lg hover:shadow-2xl transition-all duration-300 flex items-center space-x-2 font-bold active:scale-95 hover:scale-105"
            >
