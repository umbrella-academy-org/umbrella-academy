      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="bg-yellow-50 rounded-lg p-4">
            ...
            <div className="text-xl font-bold text-yellow-900">RWF 45,000</div>
            <div className="text-xs text-yellow-700">+15% vs last month</div>
          </div>
          ...
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <div className="text-xl font-bold text-green-900">RWF 890,000</div>
