...
export default function AssignmentTabs({ activeTab, onTabChange }: AssignmentTabsProps) {
  const tabs = [
    { id: 'pending', label: 'Pending Review', count: 8, color: 'text-orange-600 bg-orange-100' },
    { id: 'completed', label: 'Completed', count: 24, color: 'text-green-600 bg-green-100' },
    { id: 'overdue', label: 'Overdue', count: 3, color: 'text-red-600 bg-red-100' },
