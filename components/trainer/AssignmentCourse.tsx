        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-amber-900">18 Students</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-amber-900">8 Modules</div>
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="text-sm font-medium text-amber-900">Active</div>
          ...
          <div className="mb-4">
            <div className="flex items-center justify-between text-sm mb-2">
              ...
              <span className="font-medium text-amber-900">75% Complete</span>
            </div>
