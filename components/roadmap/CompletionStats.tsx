...
export default function CompletionStats() {
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-amber-900 mb-2">Progress Overview</h3>
        <div className="flex items-center justify-between">
          <p className="text-sm text-gray-500">Overall completion</p>
          <span className="text-sm font-medium text-amber-900">{progress.overallProgress}%</span>
        </div>
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <div key={index} className="text-center">
              ...
              <div className="text-xs font-medium text-amber-900">{stat.label}</div>
              {stat.total > 0 && (
      ...
      <div className="mt-6 pt-4 border-t border-gray-100">
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            <div className="text-sm font-medium text-amber-900">{progress.completedSessions}</div>
