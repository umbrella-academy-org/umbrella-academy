...
export default function RoadmapCreation({ roadmap, onRoadmapCreated }: RoadmapCreationProps) {
  ...
  if (step === 'payment') {
    return (
      <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100 text-center">
        ...
        <h3 className="text-xl font-semibold text-amber-900 mb-2">Processing Payment</h3>
  ...
  if (step === 'creating') {
    return (
      <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100 text-center">
        ...
        <h3 className="text-xl font-semibold text-amber-900 mb-2">Creating Your Roadmap</h3>
  ...
  if (step === 'completed') {
    return (
      <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100 text-center">
        ...
        <h3 className="text-xl font-semibold text-amber-900 mb-2">Roadmap Created!</h3>
  ...
  return (
    <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
      <div className="mb-6">
        <h3 className="text-xl font-semibold text-amber-900 mb-2">Create Your Learning Roadmap</h3>
      ...
      <div className="border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h4 className="font-semibold text-amber-900 mb-1">{roadmap.title}</h4>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-center justify-between">
          <div>
            <h4 className="font-semibold text-amber-900">Basic Plan</h4>
