    ...
    <div className="flex h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-auto p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-semibold text-amber-900">My Learning Roadmap</h1>
          ...
          {activeRoadmap ? (
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="flex items-start justify-between">
                  <div>
                    <h2 className="text-xl font-semibold text-amber-900">{activeRoadmap.roadmap.title}</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="font-semibold text-amber-900 mb-2">Current Phase</h3>
                  <p className="text-2xl font-bold text-gray-600">Phase 2</p>
                  <p className="text-sm text-gray-600">Intermediate Concepts</p>
                </div>
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="font-semibold text-amber-900 mb-2">Completed Lessons</h3>
              ...
              {/* Roadmap Phases */}
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-amber-900 mb-4">Learning Phases</h3>
                <div className="space-y-4">
                    ...
                    <div key={index} className="border border-gray-200 rounded-lg p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          <span className="text-sm font-medium text-amber-900">{phase.status === 'completed' ? 100 : phase.status === 'active' ? 50 : 0}%</span>
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-amber-900 mb-2">No Active Roadmap</h3>
