            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-2xl font-bold text-green-600">{activeRoadmap.roadmap.progress.completedSessions}/{activeRoadmap.roadmap.progress.totalSessions}</p>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  <p className="text-2xl font-bold text-blue-600">Tomorrow</p>
