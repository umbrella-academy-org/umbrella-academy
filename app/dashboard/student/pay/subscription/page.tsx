            ...
            <div className="w-full max-w-4xl">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4">
                  <h1 className="text-xl font-semibold text-white">Mentorship Subscription</h1>
                  <p className="text-purple-100 text-sm mt-1">Unlock your full potential with personalized mentorship</p>
                </div>
                ...
                <div className="p-6">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            >
                              <div className="flex items-center justify-between mb-2">
                                <span className={`font-medium ${billingCycle === 'monthly' ? 'text-purple-900' : 'text-gray-700'}`}>
                                  Monthly
                                </span>
                                {billingCycle === 'monthly' && <Sparkles className="w-4 h-4 text-purple-500" />}
                              </div>
                              <div className="text-2xl font-bold text-gray-900">
                                {monthlyPrice.toLocaleString()} <span className="text-sm font-normal text-gray-500">RWF/mo</span>
                              </div>
                            ...
                            >
                              ...
                              <div className="flex items-center justify-between mb-2">
                                <span className={`font-medium ${billingCycle === 'yearly' ? 'text-purple-900' : 'text-gray-700'}`}>
                                  Yearly
                                </span>
                                {billingCycle === 'yearly' && <Sparkles className="w-4 h-4 text-purple-500" />}
                              </div>
                              <div className="text-2xl font-bold text-gray-900">
                                {yearlyPrice.toLocaleString()} <span className="text-sm font-normal text-gray-500">RWF/yr</span>
                              </div>
                        ...
                        <div className="bg-gray-50 rounded-xl p-6">
                          ...
                          <div className="space-y-3">
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-600">Mentorship {billingCycle === 'monthly' ? 'Monthly' : 'Yearly'}</span>
                  ...
                  {paymentStep === 'success' && (
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-500 mb-6">Your mentorship subscription is now active</p>
