                ...
                <main className="flex-1 p-4 lg:p-8 overflow-y-auto bg-gray-50/30">
                    <div className="max-w-5xl mx-auto animate-fade-in">
                        ...
                        <div className="bg-white rounded-lg border border-gray-100 shadow-xl shadow-gray-200/50 overflow-hidden mb-8 ">
                            <div className="h-48 bg-gradient-to-br from-yellow-400 via-yellow-500 to-red-600 relative overflow-hidden">
                            ...
                            <div className="px-10 pb-10">
                                <div className="flex flex-col md:flex-row md:items-end -mt-16 gap-8">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute -bottom-1 -right-1 w-10 h-10 bg-yellow-500 border-4 border-white rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-6 mt-20 pb-2">
                                        <div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="px-2.5 py-1 bg-yellow-50 text-yellow-700 border border-yellow-100 rounded-full text-[10px] font-black  ">FIELD COMMANDER</div>
                                            </div>
                                ...
                                <div className="bg-white rounded-lg border border-gray-100 shadow-xl shadow-gray-200/30 p-10 ">
                                    ...
                                    <div className="grid grid-cols-2 gap-6">
                                        ...
                                        <div className="p-8 bg-yellow-600 rounded-lg text-white relative overflow-hidden group">
                                            ...
                                            <p className="text-xs text-yellow-100 font-semibold   ">Enrolled Students</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function ManagementItem({ icon, label }: { icon: React.ReactNode, label: string }) {
    return (
        <button className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-yellow-50 transition-all group border border-transparent hover:border-yellow-100">
