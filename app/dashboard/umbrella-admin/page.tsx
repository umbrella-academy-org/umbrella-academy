              ...
              <div className="bg-white rounded-lg p-3 lg:p-4 shadow-sm border border-gray-100  hover:shadow-lg transition-all duration-300 animate-slide-up">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg lg:text-xl font-bold text-amber-900">{systemStats.totalFields}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-3 lg:p-4 shadow-sm border border-gray-100  hover:shadow-lg transition-all duration-300 animate-slide-up" style={{ animationDelay: '100ms' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg lg:text-xl font-bold text-amber-900">{systemStats.totalStudents}</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-3 space-y-4 sm:space-y-6 lg:space-y-8">
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-100 animate-fade-in" style={{ animationDelay: '500ms' }}>
                  <h3 className="text-sm sm:text-base font-semibold text-amber-900 mb-4">Fields Performance</h3>
                    ...
                    {fieldPerformance.map((field, index) => (
                      <div key={field.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                        <div className="flex-1">
                          <div className="font-medium text-amber-900 text-sm">{field.name}</div>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-xs font-medium text-amber-900 w-8">{Math.round(field.performance)}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-amber-900 text-sm">Manage Fields</div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-amber-900 text-sm">User Management</div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-amber-900 text-sm">Financial Reports</div>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium text-amber-900 text-sm">System Health</div>
