...
export default function GuardianProfilePage() {
    ...
    const [profileData, setProfileData] = useState({
        name: user?.firstName && user?.lastName ? `${user.firstName} ${user.lastName}` : 'Guardian User',
        email: user?.email || 'guardian@dreamize.rw',
        phone: user?.phoneNumber || '+250 788 111 222',
        location: 'Kigali, Rwanda',
        bio: 'Dedicated guardian supporting student development and academic progress. Committed to providing guidance and ensuring the best educational outcomes for my wards.',
        expertise: ['Student Mentorship', 'Academic Support', 'Parent Communication', 'Progress Monitoring'],
        experience: '3+ Years',
        field: 'Student Development',
        joinDate: user?.createdAt ? new Date(user.createdAt).toLocaleDateString() : 'Jan 2024'
    });
                            ...
                            <div className="px-8 py-8">
                                <div className="flex flex-col md:flex-row md:items-end -mt-12 gap-6">
                                    <div className="relative group">
                                        ...
                                        <div className="absolute -bottom-1 -right-1 w-10 h-10 bg-primary border-4 border-white rounded-full flex items-center justify-center" title="Verified Guardian">
                                    ...
                                    <div className="flex-1 flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
                                        <div>
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="px-2.5 py-1 bg-primary/10 text-primary border border-primary/20 rounded-full text-[10px] font-bold uppercase tracking-wider">Verified Guardian</div>
                                            </div>
                                            <p className="text-slate-500 font-light flex items-center gap-2 mt-1.5">
                                                ...
                                                <span className="text-slate-400">Student Mentor</span>
                                            </p>
                                        </div>
                            ...
                            <div className="space-y-8">
                                <div className="bg-white rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/30 p-8">
                                    ...
                                    <div className="space-y-4">
                                        <div className="p-6 bg-slate-50 rounded-xl border border-slate-100 flex justify-between items-center group hover:bg-white hover:shadow-lg transition-all">
                                            <span className="text-sm text-slate-500 font-bold uppercase tracking-wider">Linked Students</span>
                                            <span className="text-2xl font-playfair font-semibold text-slate-900">{guardianUser?.linkedStudentIds?.length || 0}</span>
                                        </div>
                                        <div className="p-6 bg-slate-50 rounded-xl border border-slate-100 flex justify-between items-center group hover:bg-white hover:shadow-lg transition-all border-l-4 border-l-primary">
                                            <span className="text-sm text-slate-500 font-bold uppercase tracking-wider">Engagement</span>
                                            <div className="flex items-center gap-2">
                                                <Star className="w-4 h-4 text-primary fill-primary" />
                                                <span className="text-2xl font-playfair font-semibold text-slate-900">4.8</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/30 p-8">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <SettingsItem icon={<Globe className="w-4.5 h-4.5" />} label="Privacy Settings" color="slate" />
                                    </div>
                                </div>
                                ...
                                <div className="bg-slate-900 rounded-[32px] p-8 text-white relative overflow-hidden group">
                                    <div className="relative z-10 text-center">
                                        ...
                                        <h3 className="text-xl font-playfair font-semibold mb-2">Guardian Badge</h3>
                                        <p className="text-slate-400 text-xs font-medium mb-6 leading-relaxed">Your guardian credentials have been fully verified by the Academy board.</p>
