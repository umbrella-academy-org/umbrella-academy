      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
        <main className="flex-1 overflow-auto">
          <div className="p-3 lg:p-4">
            <div className="mb-6">
              <h1 className="text-2xl font-semibold text-amber-900 mb-2">Roadmap Approvals</h1>
              ...
              <div className="lg:col-span-1">
                <div className="bg-white rounded-lg shadow-sm border border-gray-100">
                  <div className="p-4 border-b border-gray-200">
                    <h3 className="font-semibold text-amber-900">Pending Approvals ({pendingRoadmaps.length})</h3>
                  </div>
                  <div className="divide-y divide-gray-200">
                    {pendingRoadmaps.map((roadmap) => (
                      <div
                        key={roadmap.id}
                        className={`p-4 cursor-pointer hover:bg-gray-50 transition-colors ${selectedRoadmap === roadmap.id ? 'bg-gray-50 border-r-4 border-amber-600' : ''
                          }`}
                        onClick={() => setSelectedRoadmap(roadmap.id)}
                      >
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <h4 className="font-medium text-amber-900">{roadmap.student.name}</h4>
              ...
              <div className="lg:col-span-2">
                {selectedRoadmapData ? (
                  <div className="bg-white rounded-lg shadow-sm border border-gray-100">
                    ...
                    <div className="p-6 border-b border-gray-200">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <h2 className="text-xl font-semibold text-amber-900">{selectedRoadmapData.goal}</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div>
                            <div className="font-medium text-amber-900">Student</div>
                        ...
                        <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                          <User className="w-5 h-5 text-gray-600" />
                          <div>
                            <div className="font-medium text-amber-900">Trainer</div>
                    ...
                    {/* Roadmap Summary */}
                    <div className="p-6 border-b border-gray-200">
                      <h3 className="font-semibold text-amber-900 mb-4">Roadmap Summary</h3>
                    ...
                    {/* Phases Details */}
                    <div className="p-6">
                      <h3 className="font-semibold text-amber-900 mb-4">Learning Phases</h3>
                          ...
                          <div key={phase.id} className="border border-gray-200 rounded-lg p-4">
                            <div className="flex items-start gap-4">
                              ...
                              <div className="flex-1">
                                <h4 className="font-medium text-amber-900 mb-1">{phase.title}</h4>
                  ...
                  <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-12 text-center">
                    ...
                    <h3 className="text-lg font-medium text-amber-900 mb-2">Select a Roadmap</h3>
