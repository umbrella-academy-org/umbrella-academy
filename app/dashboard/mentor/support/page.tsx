      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-auto p-6">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6">
              <h1 className="text-2xl font-semibold text-amber-900">Mentor Support Center</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  <h3 className="font-semibold text-amber-900 mb-3">Common Mentor Issues</h3>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-800">Mentor Resources</p>
                      <p className="text-sm text-gray-700">Access mentoring guidelines and best practices in your mentor dashboard.</p>
                    </div>
                  </div>
                </div>
              </div>
