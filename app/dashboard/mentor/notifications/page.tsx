          ...
          <div className="max-w-fullmx-auto p-4 lg:p-8 space-y-8">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <button className="px-5 py-2.5 bg-yellow-600 text-white text-xs font-semibold rounded-lg hover:bg-yellow-700 shadow-lg shadow-gray-600/20 transition-all active:scale-95">
                  Mark All Read
                </button>
