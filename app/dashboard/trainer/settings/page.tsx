            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <main className="flex-1 p-4 lg:p-8 overflow-y-auto bg-gray-50/30">
                    <div className="max-w-5xl mx-auto">
                        <div className="mb-8">
                            <h1 className="text-3xl font-semibold text-gray-900 mb-2">Trainer Settings</h1>
                        ...
                        <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="flex-1">
                                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 lg:p-8 animate-fade-in">
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        ...
                                                        <div className="grid grid-cols-1 gap-4">
                                                            <input type="password" placeholder="Current Password" className="px-4 py-3 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-600" />
                                                            <input type="password" placeholder="New Password" className="px-4 py-3 border border-gray-200 rounded-lg outline-none focus:ring-2 focus:ring-green-600" />
                                                        </div>
                                                    </div>
                                                    <button className="px-6 py-2.5 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 shadow-md">
                                                        Update Security
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    {activeSection === 'notif' && (
                                        <div className="space-y-6">
                                            <h3 className="text-lg font-semibold text-gray-900 mb-4">Teaching Alerts</h3>
                                                ...
                                                {[
                                                    ...
                                                    <div key={pref.id} className="flex items-center justify-between">
                                                        ...
                                                        <button
                                                            ...
                                                            className={`w-12 h-6 rounded-full transition-all relative ${notifications[pref.id as keyof typeof notifications] ? 'bg-green-600' : 'bg-gray-200'}`}
                                                        >
                                    ...
                                    {(activeSection === 'teaching' || activeSection === 'wing' || activeSection === 'payouts') && (
                                        <div className="flex flex-col items-center justify-center py-20 text-center">
                                            ...
                                            <h3 className="text-lg font-semibold text-gray-900">Module Optimization</h3>
