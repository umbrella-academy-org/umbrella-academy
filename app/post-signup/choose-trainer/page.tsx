...
export default function ChooseTrainerPage() {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    router.push('/dashboard/student/chat?roadmap=true');
  };
            ...
            <form onSubmit={handleContinue} className="w-full">
              <div className="space-y-4 mb-8">
                {trainers.map((mentor) => (
                  ...
                  >
                    <div className={`overflow-hidden w-14 h-14 rounded-full flex items-center justify-center text-white font-semibold ${selectedTrainer === mentor.id ? 'bg-yellow-600' : 'bg-gradient-to-br from-gray-500 to-gray-600'
                      }`}>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <div className="flex items-start gap-4 mb-6">
                ...
                <div className="text-right">
                  <div className="text-sm text-gray-600">{viewingProfile.availability}</div>
                </div>
              </div>
