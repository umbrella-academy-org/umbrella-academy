...
export default function MentorUploadProofsPage() {
  ...
  const handleContinue = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem('mentorProofDocuments', JSON.stringify(urls));
      ...
      <div className="flex flex-[2] flex-col justify-between p-8 bg-white h-screen overflow-auto">
        <div className="flex flex-col flex-1 max-w-md mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-center flex-1">
            ...
            {/* Title */}
            <h1 className="text-3xl font-semibold text-gray-900 mb-2">Upload Your Proofs</h1>
