...
export default function MentorProfilePage() {
  ...
  const handleContinue = (e: React.FormEvent) => {
    ...
    localStorage.setItem('mentorPhoneCode', phoneCode);
    localStorage.setItem('mentorPhoneNumber', phoneNumber);
        ...
        <div className="flex flex-col flex-1 max-w-md mx-auto w-full">
          ...
          <div className="flex flex-col items-center justify-center flex-1">
            ...
            <p className="text-gray-500 mb-8 text-center">
              Introduce your expertise and mentoring approach in a few sentences.
            </p>
            ...
            <form onSubmit={handleContinue} className="w-full space-y-4">
              <div>
                ...
                <textarea
                  ...
                  placeholder="I'm a senior software engineer with 15+ years of experience in distributed systems and cloud architecture..."
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <p className="text-sm text-gray-500 ml-auto">{bio.length}/275 characters left</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className="px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent text-gray-900 appearance-none bg-white w-28"
                  >
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-600 focus:border-transparent text-gray-900 placeholder:text-gray-400"
                  />
                </div>
              </div>
