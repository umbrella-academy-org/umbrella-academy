                  ...
                  return (
                    <div
                      ...
                      className={`relative p-8 rounded-xl text-left transition-all duration-300 cursor-pointer group hover:scale-[1.03] ${isSelected
                        ? 'bg-white border-2 border-gray-600 shadow-2xl shadow-gray-600/10'
                    ...
                    >
                      ...
                      <div className="absolute top-6 right-6">
                        {isSelected && (
                          <div className="bg-gray-600 text-white p-1 rounded-full animate-in zoom-in-50 duration-500">
                      ...
                      <div className="mb-8">
                        <div className='flex justify-between items-start'>
                          ...
                          <div className={`w-10 h-10 rounded-lg flex items-center justify-center text-xl shadow-inner transition-all duration-500 ${isSelected ? 'bg-gray-600 text-white rotate-6' : 'bg-slate-50 text-slate-400 group-hover:bg-gray-50 group-hover:text-gray-600 group-hover:rotate-6'
                            }`}>
                            {field.icon}
                          </div>
                        </div>
