        ...
        <div className="flex flex-col items-center justify-center flex-1 max-w-md mx-auto w-full">
          ...
          <form onSubmit={handleContinue} className="w-full space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-lg font-medium hover:bg-gray-50 transition-colors text-black"
            >
