      ...
      <div className="flex flex-[2] flex-col justify-between p-8 bg-white">
        <div className="flex flex-col items-center justify-center flex-1 max-w-md mx-auto w-full">
          ...
          <button
            ...
            className="self-start flex items-center gap-2 text-gray-600 hover:text-amber-900 mb-8"
          >
          ...
          <form onSubmit={handleContinue} className="w-full space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-transparent text-amber-900 placeholder:text-gray-400 ${error ? 'border-gray-500' : 'border-gray-300'
                  }`}
                required
              />
